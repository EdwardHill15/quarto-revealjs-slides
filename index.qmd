...
format:
  revealjs:
    ...
    title-slide-attributes:
      data-background-image: "background2.png"
    footer: |
      <a href="https://quarto.org">https://quarto.org</a>

embed-resources: true
---

```{r}
#| label: setup python and R environment
#| echo: false
#| results: "hide"
#| warning: false
#| message: false
...
dt <- read.csv("avidya_dukkha.csv")


use_python(
  "D:/Onderzoek/Quarto_revealjs/Quarto_Python/slideshow/.venv/Scripts/python.exe",
  required = TRUE
)
...
## Hello, There {background-image="background2.png"}
...
## R Avidya-Dukkha dataframe {background-image="background2.png"}
...
dt |> 
  select(c(2:10,19)) |> 
  mutate(avidya = factor(avidya, levels = c("low", "mid", "high"))) |> 
  ggplot(aes(x=negativism,y=anxiety, fill=avidya, col = avidya)) +
...
df = pd.read_csv("avidya_dukkha.csv")
...
## Avidya-Dukkha1 {.smaller .scrollable transition="slide"}
...
dt |> 
  mutate(avidya = factor(avidya, levels = c("low", "mid", "high"))) |> 
  ggplot(aes(x=psychopathology,y=neuroticism, fill=avidya, col = avidya)) +
  geom_point(size = 6, alpha=0.7) +
  scale_color_manual(
    values=c(
      "low" = "blue",
...
::: footer
Theoretical background: [Website](https://resonance-consciousness.netlify.app/articles/rtc%20and%20buddha/)
:::

## Avidya-Dukkha2 {.smaller .scrollable transition="slide"}
...
dt |>
  ...
  ggplot(aes(x = avidya, y = neuroticism, fill = avidya)) +
  ...
  labs(
    x = "Avidya",
    y = "Neuroticism",
    title = "Neuroticism by Avidya Level"
  ) +
  theme_minimal() 
```
